...
class Student_list_DBTest {
    ...
    fun setup() {
        try {
            connection = DriverManager.getConnection(
                "jdbc:postgresql://localhost:5432/Student2",
                "postgres",
                "postgres"
            )
    ...
    fun get_by_id(id:Int) {
        ...
        if (result != null) {
            ...
            return assertEquals(Student(list_args.get(0).toInt(),student_string).toString(),"Prokopenko Evgeniy Batkovich phone=+79788502497 telegram=@evgeny email=evgeny@mail.ru git=evgeny/evgeny ")
        }
    }
    @Test
    @Order(2)
    ...
    fun update_student() {
        ...
        var update="Update student3  " +
                "set lastName='Kisliy',firstName='Daniya',surname='Danilovich', telegram='@kisliy', phone='+79872288228', email='kisliy@mail.ru', git='kisliy/kisliy'" +
                "where id = 1;"
        ...
        if (result != null) {
            ...
            return assertEquals(Student(list_args.get(0).toInt(),student_string).toString(),"Kisliy Daniya Danilovich phone=+79872288228 telegram=@kisliy email=kisliy@mail.ru git=kisliy/kisliy ")
        }
    }
}